...
let projects = [
  {
    image: 'textures/achieve-with-me.png',
    url: 'https://achieve-with-me.vercel.app',
  },
  {
    image: 'textures/ecommercestore.png',
    url: 'https://rana-reebaal-hackathon.vercel.app',
  },
  {
    image: 'textures/fullstack-ecommerce-site.png',
    url: 'https://fullstack-ecommerce-site.vercel.app',
  },
  {
    image: 'textures/AlMadinah MotorsRentACar.png',
    url: 'https://al-madina-motors-rent-a-car.vercel.app',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Rabees Hussain', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      "Hi, I'm FullStack Developer and Designer.",
      {
        font: font,
        size: 0.018,
        height: 0,
